...
const remoteDbQuery = 'authSource=%24external&authMechanism=MONGODB-AWS&retryWrites=true&w=majority';
const remoteDb = `${MONGO_DATABASE_HOST}/${MONGO_DATABASE_NAME}?${remoteDbQuery}`;
