...
module.exports.canGetCompany = (caller, resourceId) => companyRbac(caller, resourceId, { authorizedRoles: ['superuser', 'user'] });

module.exports.canUpdateCompany = (caller, resourceId) => companyRbac(caller, resourceId, { authorizedRoles: ['superuser'] });
